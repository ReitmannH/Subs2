...
namespace Subs.Business
{
    public static class IssueBiz
    {
        ...
        //private static Data.PaymentDocTableAdapters.IssueCandidateTableAdapter gIssueCandidateAdapter = new Data.PaymentDocTableAdapters.IssueCandidateTableAdapter();
        //private static PaymentDoc.IssueCandidateDataTable gIssueCandidate = new PaymentDoc.IssueCandidateDataTable();
        ...
        public static string Skip(int SubscriptionId, int IssueId)
        {
            ...
            try
            {
                ...
                //// Find the next paid issue

                //if (lSubscriptionIssueRow.Paid)
                //{
                //    // Mark the next in line for being paid.

                //    int FirstSequenceNotPaid = 10000;
                ...
                //        else
                //        {
                //            if (lRow.Sequence < FirstSequenceNotPaid)
                //            {
                //                FirstSequenceNotPaid = lRow.Sequence;
                //            }
                //        }
                //    }

                //    // Pay the appropriate one

                //    int lIssueId = 0;
                //    {
                //        string lResult;

                //        if ((lResult = ProductData.GetIssueId(ProductId, FirstSequenceNotPaid, out lIssueId)) != "OK")
                //        {
                //            return lResult;
                //        }
                //    }

                //    SubscriptionDoc3.SubscriptionIssueRow lPaymentRecipient = lSubscriptionIssue.FindByIssueIdSubscriptionId(lIssueId, SubscriptionId);
                //    lPaymentRecipient.Paid = true;
                //    if (!lSubscriptionIssueRow.IsPaymentTransactionIdNull())
                //    {
                //        lPaymentRecipient.PaymentTransactionId = lSubscriptionIssueRow.PaymentTransactionId;
                //    }
                //}
