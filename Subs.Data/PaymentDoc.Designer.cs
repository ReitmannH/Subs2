...
namespace Subs.Data {
    ...
    public partial class PaymentDoc : global::System.Data.DataSet {
        ...
        public partial class FNBBankStatementDataTable : global::System.Data.TypedTableBase<FNBBankStatementRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FNBBankStatementRow AddFNBBankStatementRow(int StatementNo, int AllocationNo, System.DateTime TransactionDate, bool Posted, decimal Amount, string Reference, int CustomerId, string ErrorMessage, string BankTransactionType, string BankPaymentMethod, string ModifiedBy, System.DateTime ModifiedOn, int PaymentTransactionId) {
        ...
        public partial class FNBBankStatementRow : global::System.Data.DataRow {
            ...
            public string ErrorMessage {
                get {
                    try {
                        return ((string)(this[this.tableFNBBankStatement.ErrorMessageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ErrorMessage\' in table \'FNBBankStatement\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableFNBBankStatement.ErrorMessageColumn] = value;
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsErrorMessageNull() {
                return this.IsNull(this.tableFNBBankStatement.ErrorMessageColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetErrorMessageNull() {
                this[this.tableFNBBankStatement.ErrorMessageColumn] = global::System.Convert.DBNull;
            }
...
FROM            DebitOrderBankStatement";
    ...
    public partial class FNBBankStatementTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [FNBBankStatement] WHERE (([PaymentId] = @Original_PaymentId) AND ((@IsNull_StatementNo = 1 AND [StatementNo] IS NULL) OR ([StatementNo] = @Original_StatementNo)) AND ([AllocationNo] = @Original_AllocationNo) AND ([TransactionDate] = @Original_TransactionDate) AND ([Posted] = @Original_Posted) AND ([Amount] = @Original_Amount) AND ([Reference] = @Original_Reference) AND ((@IsNull_PaymentTransactionId = 1 AND [PaymentTransactionId] IS NULL) OR ([PaymentTransactionId] = @Original_PaymentTransactionId)) AND ((@IsNull_CustomerId = 1 AND [CustomerId] IS NULL) OR ([CustomerId] = @Original_CustomerId)) AND ((@IsNull_ErrorMessage = 1 AND [ErrorMessage] IS NULL) OR ([ErrorMessage] = @Original_ErrorMessage)) AND ((@IsNull_BankTransactionType = 1 AND [BankTransactionType] IS NULL) OR ([BankTransactionType] = @Original_BankTransactionType)) AND ((@IsNull_BankPaymentMethod = 1 AND [BankPaymentMethod] IS NULL) OR ([BankPaymentMethod] = @Original_BankPaymentMethod)) AND ([ModifiedBy] = @Original_ModifiedBy) AND ([ModifiedOn] = @Original_ModifiedOn))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_PaymentId", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PaymentId", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [FNBBankStatement] ([StatementNo], [AllocationNo], [TransactionDate], [Posted], [Amount], [Reference], [PaymentTransactionId], [CustomerId], [ErrorMessage], [BankTransactionType], [BankPaymentMethod], [ModifiedBy], [ModifiedOn]) VALUES (@StatementNo, @AllocationNo, @TransactionDate, @Posted, @Amount, @Reference, @PaymentTransactionId, @CustomerId, @ErrorMessage, @BankTransactionType, @BankPaymentMethod, @ModifiedBy, @ModifiedOn);
SELECT PaymentId, StatementNo, AllocationNo, TransactionDate, Posted, Amount, Reference, PaymentTransactionId, CustomerId, ErrorMessage, BankTransactionType, BankPaymentMethod, ModifiedBy, ModifiedOn FROM FNBBankStatement WHERE (PaymentId = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StatementNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StatementNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AllocationNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "AllocationNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TransactionDate", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "TransactionDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [FNBBankStatement] SET [StatementNo] = @StatementNo, [AllocationNo] = @All" +
                "ocationNo, [TransactionDate] = @TransactionDate, [Posted] = @Posted, [Amount] = " +
                "@Amount, [Reference] = @Reference, [PaymentTransactionId] = @PaymentTransactionI" +
                "d, [CustomerId] = @CustomerId, [ErrorMessage] = @ErrorMessage, [BankTransactionT" +
                "ype] = @BankTransactionType, [BankPaymentMethod] = @BankPaymentMethod, [Modified" +
                "By] = @ModifiedBy, [ModifiedOn] = @ModifiedOn WHERE (([PaymentId] = @Original_Pa" +
                "ymentId) AND ((@IsNull_StatementNo = 1 AND [StatementNo] IS NULL) OR ([Statement" +
                "No] = @Original_StatementNo)) AND ([AllocationNo] = @Original_AllocationNo) AND " +
                "([TransactionDate] = @Original_TransactionDate) AND ([Posted] = @Original_Posted" +
                ") AND ([Amount] = @Original_Amount) AND ([Reference] = @Original_Reference) AND " +
                "((@IsNull_PaymentTransactionId = 1 AND [PaymentTransactionId] IS NULL) OR ([Paym" +
                "entTransactionId] = @Original_PaymentTransactionId)) AND ((@IsNull_CustomerId = " +
                "1 AND [CustomerId] IS NULL) OR ([CustomerId] = @Original_CustomerId)) AND ((@IsN" +
                "ull_ErrorMessage = 1 AND [ErrorMessage] IS NULL) OR ([ErrorMessage] = @Original_" +
                "ErrorMessage)) AND ((@IsNull_BankTransactionType = 1 AND [BankTransactionType] I" +
                "S NULL) OR ([BankTransactionType] = @Original_BankTransactionType)) AND ((@IsNul" +
                "l_BankPaymentMethod = 1 AND [BankPaymentMethod] IS NULL) OR ([BankPaymentMethod]" +
                " = @Original_BankPaymentMethod)) AND ([ModifiedBy] = @Original_ModifiedBy) AND (" +
                "[ModifiedOn] = @Original_ModifiedOn));\r\nSELECT PaymentId, StatementNo, Allocatio" +
                "nNo, TransactionDate, Posted, Amount, Reference, PaymentTransactionId, CustomerI" +
                "d, ErrorMessage, BankTransactionType, BankPaymentMethod, ModifiedBy, ModifiedOn " +
                "FROM FNBBankStatement WHERE (PaymentId = @PaymentId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@StatementNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "StatementNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@AllocationNo", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "AllocationNo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@TransactionDate", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "TransactionDate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
