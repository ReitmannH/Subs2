...
namespace Subs.Data
{
     public static class AdministrationData2
    {
        ...
        public static bool InsertByGUID(Guid pGUID, string pUsage, string pEmail)
        {
            ...
            try
            {
                ...
                lAdapter.Insert(pGUID, pUsage, pEmail, DateTime.Now, System.Environment.UserName);
                return true;
            }
            catch (Exception ex)
            {
                ...
                {
                    ExceptionLevel++;
                    ExceptionData.WriteException(1, ExceptionLevel.ToString() + " " + CurrentException.Message, "static AdministrationData2", "InsertByGUID", "");
                    CurrentException = CurrentException.InnerException;
                } while (CurrentException != null);
