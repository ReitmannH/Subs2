        ...
        {
            {
                ...
                {
                    System.Windows.MessageBox.Show(lResult);
                    return;
                }
            }
            System.Windows.MessageBox.Show("Update of product data successful.");
        }
       ...
       private void Exit_Click(object sender, RoutedEventArgs e)
       {
        ...
        private void buttonSubmitBaseRate_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                System.Windows.MessageBox.Show("Update of base rate data successful.");
            }
            catch (Exception ex)
            {
                //Display all the exceptions
        ...
        private void buttonCalculateBaseRate_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ElicitDecimal lElicitUnitPrice = new ElicitDecimal("What do you want the final price to be for a South African with the default delivery method?");
                lElicitUnitPrice.ShowDialog();
                if (lElicitUnitPrice.Answer == 0M)
                {
                    System.Windows.MessageBox.Show("You have not supplied me with a valid Unit Price! Please try again.");
                    return;
                }

                lUnitPrice = lElicitUnitPrice.Answer/ gCurrentProductRow.DefaultNumberOfIssues;

                ElicitInteger lElicitUnitsPerIssue = new ElicitInteger("How many Units per Issue");
                ...
                int lUnitsPerIssue = lElicitUnitsPerIssue.Answer;
