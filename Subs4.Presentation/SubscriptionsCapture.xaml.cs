    ...
    public partial class SubscriptionsCapture : Window
    {
        ...
        public SubscriptionsCapture(SubscriptionData3 pSubscriptionData)
        {
            ...
            try
            {
                ...
                this.textReceiverCompany.Text = gReceiver.CompanyNaam;

                gPayer = new CustomerData3(gTemplateSubscription.PayerId);
                this.textPayerSurname.Text = gPayer.Surname;
                this.textPayerCompany.Text = gPayer.CompanyNaam;
            ...
            {
                {
                    ...
                    if ((lResult = SubscriptionBiz.SetInitialValues(pSubscriptionData, DateTime.Now)) != "OK")
                    {
                ...
                Subs.Data.MimsValidationResult lValidationResult = pSubscriptionData.Validate();
        ...
        private bool FilterProducts(object o)
        {
            ...
            if ((int)comboSubscriptionType.SelectedValue == (int)SubscriptionType.Any && (int)comboSubscriptionMedium.SelectedValue == (int)SubscriptionMedium.Both)
            {
                return true;
            }
            ...
            if ((int)comboSubscriptionMedium.SelectedValue == (int)SubscriptionMedium.Both)
            {
