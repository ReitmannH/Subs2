...
namespace Subs4.Presentation
{
    ...
    public partial class SubscriptionPicker2 : Window
    {
        ...
        {
            Subs4.Presentation.IssuePicker2 frmIssuePicker = new Subs4.Presentation.IssuePicker2();
        ...
        public void SelectById(int pSubscriptionId)
        {
            try
            {
                ...
                Subs4.Presentation.SubscriptionDetailControl2 lUserControl = new Subs4.Presentation.SubscriptionDetailControl2(this, gSubscriptionDerived);
                SubscriptionGrid.Content = lUserControl;
                return;
            }
            catch (Exception ex)
            {
        ...
        private void SelectByPayer_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                //gSubscriptionIds = gDataContext.MIMS_SubscriptionPicker_FillById("ByPayer", Settings.CurrentCustomerId, 0).ToList();
        ...
        {
            SubscriptionGrid.Content = new Subs4.Presentation.SubscriptionDormantControl((ContextMenu)this.Resources["ContextTransactions"]);
        }
        ...
        private void Cancel()
        {
            ...
            try
            {
                ...
                if (gSubscriptionData.InvoiceId == null)
                {
                    {
                        string lResult;

                        if ((lResult = SubscriptionBiz.Cancel(gSubscriptionData, "Cancelled before invoiced")) != "OK")
                        {
                            MessageBox.Show(lResult);
                            return;
                        }
                    }
                    MessageBox.Show("Subscription destroyed.");
                    return;
                }
            ...
            catch (Exception ex)
            {
                ...
                {
                    ExceptionLevel++;
                    ExceptionData.WriteException(1, ExceptionLevel.ToString() + " " + CurrentException.Message, this.ToString(), "Cancel", "SubscriptionId = " + lCurrentSubscriptionId.ToString());
                    CurrentException = CurrentException.InnerException;
                } while (CurrentException != null);
        ...
        private void Click_DeliverOnCredit(object sender, RoutedEventArgs e)
        {
            ...
            Subs4.Presentation.PaymentAllocation lPaymentAllocation = new Subs4.Presentation.PaymentAllocation(lCurrentSubscriptionId);
        ...
        private void Click_Renew(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Subs4.Presentation.SubscriptionsCapture lSubscriptionsCapture = new Subs4.Presentation.SubscriptionsCapture(lSourceSubscriptionData);
                lSubscriptionsCapture.ShowDialog();
