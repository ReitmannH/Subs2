...
namespace Subs4.Presentation
{
    public partial class SubscriptionCaptureChange : Window
    {
        ...
        private void buttonSelectDeliveryAddress_Click(object sender, RoutedEventArgs e)
        {
            ...
            Subs4.Presentation.DeliveryAddress2 lDeliveryAddress = new Subs4.Presentation.DeliveryAddress2(gBasketItem.Subscription.ReceiverId);
        ...
        private void buttonReturn_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Subs.Data.MimsValidationResult lValidationResult = gBasketItem.Subscription.Validate();
