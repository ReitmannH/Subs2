    ...
    public partial class FNBBankStatement : Window
    {
        ...
        private void buttonValidate_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                foreach (PaymentDoc.FNBBankStatementRow lRow in gPaymentDoc.FNBBankStatement.Rows)
                {
                    ...
                    {
                        if (lRow.ErrorMessage == "OK" || lRow.ErrorMessage == "Incorrectly deposited" || lRow.ErrorMessage == "Internal transfer" || lRow.ErrorMessage == "Overridden" || lRow.Posted)
                        {
        ...
        private int CreateAStatement(int pPayerId)
        {
            try
            {
                ...
                lStatementControl.Load(pPayerId, lStatementId);
        ...
        private void Override_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Settings.Authority >= 2)
            {
                ...
                {
                    lRow.ErrorMessage = lRow.ErrorMessage + " Overridden";
                }
            }
        }
