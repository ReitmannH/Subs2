...
namespace Subs4.Presentation
{
    public partial class DebitOrderBankStatement : Window
    {
        ...
        //{
        //    int lCounter = 1;
        //    string CSVFile = "c:\\Subs\\LS99" + lCounter.ToString().PadLeft(4, '0') + "_" + calenderDeliver.SelectedDate.Value.Year.ToString()
        //            + calenderDeliver.SelectedDate.Value.Month.ToString("0#")
        //            + ".txt";
        ...
        //                    lString.Clear();
        //                    lString.Append("MIMSId" + lPreviousProposal.CustomerId.ToString());
        ...
        //                    lString.Append("," + DateTime.Now.Date.ToString("yyyyMMdd"));
        ...
        //        lString.Append("," + lAmount.ToString("#######0.00"));
        //        lString.Append("," + lPreviousProposal.AccountNo);
        //        lString.Append("," + lPreviousProposal.BankCode);
        //        lString.Append("," + DateTime.Now.Date.ToString("yyyyMMdd"));
